...
<div class="wrapper">
	...
	<span class="brand-text font-weight-light">SI - ADPB2</span>
	</a>
	<!-- Sidebar -->
	<div class="sidebar">
      ...
      <li class="nav-item has-treeview">
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <a href="index.php?page=infoberkas_a" class="nav-link">
              <p>&rarr; Penerimaan Basan Baran</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="index.php?page=infoberkas_b" class="nav-link">
              <p>&rarr; Pengeluaran Basan Baran<br>Sebelum Putusan Pengadilan</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="index.php?page=infoberkas_c" class="nav-link">
	...
	<div class="content-wrapper">
        ...
        <?php include 'header.php'; ?>
          ...
          elseif($page=='infoberkas_a') {
            include 'infoberkas_a.php';
          }
          elseif($page=='infoberkas_b') {
            include 'infoberkas_b.php';
          }
          elseif($page=='infoberkas_c') {
            include 'infoberkas_c.php';
          }
          elseif($page=='berhasil') {
            echo "<script>window.alert('Berkas Berhasil Diupload')
            window.location.href='index.php'
            </script>";
          }
          elseif($page=='gagal') {
            echo "<script>window.alert('Berkas Gagal Diupload')
            window.location.href='index.php'
            </script>";
          }
          elseif($page=='b_hapus') {
            echo "<script>window.alert('Berkas Berhasil Dihapus')
            window.location.href='index.php'
            </script>";
          }
          elseif($page=='g_hapus') {
            echo "<script>window.alert('Berkas Gagal Dihapus')
            window.location.href='index.php'
            </script>";
          }
          else {
